...
def build(m):
    ...
    b.append(m.marker(P, 44.0975, -71.6796, "Flume Gorge", "storm-day plan", "stop"))
    ...
    b.append(m.marker(P, 44.1719, -71.6976, "Cannon Mtn Tramway", "", "stop", r=6))
    b.append(m.marker(P, 44.0462, -71.6712, "Lincoln", "your base", "base", r=10))
    ...
    b.append(m.marker(P, 45.5227, -73.6031, "St-Viateur & Fairmount Bagel", "4 min apart · 24 h", "stop", r=7))
    ...
    b.append(m.marker(P, 47.443, -70.501, "Baie-Saint-Paul", "nights 10–11", "base", r=12))
